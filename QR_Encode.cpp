/*      A simple tool to generate QR-Codes
 *      By jo@joembedded.de http://www.joembedded.de
 *
 *      Built with Embarcadero® C++Builder 10.2
 *
 *      QR-Routines based on https://github.com/swex/QR-Image-embedded   *** Kudos!!! ***
 */
